...
class Table {
    ...
    canTileMove(x, y) {
        ...
        if (this.tiles[aboveCoords.y][aboveCoords.x]) {
            if (this.tiles[aboveCoords.y][aboveCoords.x].blank) {
                return aboveCoords;
            }
            ;
        }
        if (this.tiles[belowCoords.y][belowCoords.x]) {
            if (this.tiles[belowCoords.y][belowCoords.x].blank) {
                return belowCoords;
            }
            ;
        }
        if (this.tiles[leftCoords.y][leftCoords.x]) {
            if (this.tiles[leftCoords.y][leftCoords.x].blank) {
                return leftCoords;
            }
            ;
        }
        if (this.tiles[rightCoords.y][rightCoords.x]) {
            if (this.tiles[rightCoords.y][rightCoords.x].blank) {
                return rightCoords;
            }
            ;
        }
    ...
    resize(s) {
        this.width = s !== null && s !== void 0 ? s : this.width;
        this.height = s !== null && s !== void 0 ? s : this.height;
...
const handleFile = function () {
    const input = document.querySelector('input#fileinput');
