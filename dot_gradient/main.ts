...
const fpsDOM = document.querySelector<HTMLInputElement>('#fps')!;
const fpsDisplayDOM = document.querySelector<HTMLElement>('#fpsDisplay')!;
const radiusDOM = document.querySelector<HTMLInputElement>('#radius')!;
const radiusDisplayDOM = document.querySelector<HTMLElement>('#radiusDisplay')!;
const sinWaveRadiusDOM = document.querySelector<HTMLInputElement>('#sinWaveRadius')!;
const modeSelectDOM = document.querySelector<HTMLSelectElement>('#mode')!;
const foregroundColourDOM = document.querySelector<HTMLInputElement>('#foregroundColour')!;
const foregroundColourDisplayDOM = document.querySelector<HTMLElement>('#foregroundColourDisplay')!;
const backgroundColourDOM = document.querySelector<HTMLInputElement>('#backgroundColour')!;
const backgroundColourDisplayDOM = document.querySelector<HTMLElement>('#backgroundColourDisplay')!;
...
let state: "circle" | "mouse" | string = "circle";
let fps = 25;
...
const createGravityPointGradient = (
    centreX: number = 0.5,
    centreY: number = 0.5,
    gradrad: number = gradientRadius,
    red: number = 0,
    green: number = 0,
    blue: number = 0,
